...
//  } 
  */
  ...
  //아이디 찾기
  Member findMemberByNamePhoneNumber(@Param("name") String name, @Param("phoneNumber") String phoneNumber) throws Exception{
	  return memberRepository.findMemberByNamePhoneNumber(name, phoneNumber);
  }; 
  
  //비밀번호 재설정
  Member findMember(@Param("name") String name, @Param("email") String email, @Param("phoneNumber") String phoneNumber) throws Exception{
	  return memberRepository.findMember(name, email, phoneNumber);
  }; 
  
  //로그인
  Member findMemberByEmailPassword(@Param("email") String email, @Param("password") String password) throws Exception{
	  return memberRepository.findMemberByNamePhoneNumber(email, password);
  }; 
