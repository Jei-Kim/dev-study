package com.swu.studywithus.config;
...
public class AppConfig {
  ...
  public SqlSessionFactory sqlSessionFactory(
    ...
    // 
    sqlSessionFactoryBean.setTypeAliasesPackage("com.studywithus.domain");
    sqlSessionFactoryBean.setMapperLocations(
        appCtx.getResources("classpath:com/studywithus/dao/*Dao.xml"));
